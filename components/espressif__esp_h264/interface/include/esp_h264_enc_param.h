...
/**
 * @brief Request an IDR on the next encoded frame without changing the GOP.
 *
 * Local backport of the force-IDR contract from the 1.3.8 development component.
 * Repeated requests before an encode coalesce; software encoders may return
 * ESP_H264_ERR_UNSUPPORTED. A NULL handle returns ESP_H264_ERR_ARG.
 */
